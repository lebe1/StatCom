...
ggparcoord(df, columns = match(c("median_age", "youth_unemployed_rate", "net_migration_rate"), names(df)), groupColumn = "income_group", showPoints = TRUE, title = "Parallel Coordinate Plot")
